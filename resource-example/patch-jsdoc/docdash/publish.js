    ...
    if (items && items.length) {
        ...
        items.forEach(function(item) {
            ...
            if ( !hasOwnProp.call(item, 'longname') ) {
                ...
                var shortName =displayName.replace(/\b(module|event):/g, '');
                itemsNav += linktoFn(item.longname, shortName);
                ...
                if (methods.length) {
                    ...
                    methods.forEach(function (method) {
                        ...
                        itemsNav += "<li data-type='method' title='"+method.name+" of "+ shortName +"' ";
                        if(docdash.collapse)
                            itemsNav += " style='display: none;'";
                        itemsNav += ">";
