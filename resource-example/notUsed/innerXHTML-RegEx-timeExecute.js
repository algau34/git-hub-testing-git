 ...
 *
 * @param tags {string} tag name , the one who must disappear
 * @returns {*}
 */
 ...
 *
 * @param loadJs load the js  if true else just the source
 * @param refXhtml {Object} is the  reference with new HTML
 * @returns {(*|string)[]}
 */
 ...
 *
 * @param boundingTagStr {String} parent teg name
 ...
 *
 * @param aSrcs {Array}  Array 's Strings of src for each piece htmlStr
 * @param templateHtml {String} piece of html
 * @param targetBeforeElmtFirst {string} tag name , where the Elment must to
 * insert before begin ths, else if not present then inser beforeend of Elemnt (this)
 */
